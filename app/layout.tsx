  ...
  return (
    <html lang="en" className={`${mulish.variable} ${jetbrainsMono.variable}`}>
      <body suppressHydrationWarning>
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-[#ed5c2c] focus:text-[#051424] focus:text-[16px] focus:leading-[24px] focus:rounded-[12px] focus:font-medium"
        >
