...
export default function CeliaSenekalPage() {
  ...
  const celiaTestimonials = testimonials.people.filter(t =>
    t.testimony.toLowerCase().includes('celia') ||
    t.name.toLowerCase().includes('celia') ||
    t.testimony.toLowerCase().includes('senekal')
  )

  // Parse the howIHelp text into intro and bullet points
  const howIHelpText = celia.howIHelp || ''
  ...
  return (
    <>
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center pt-20 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#051424] via-[#051424]/95 to-[#051424]/40" />
          <div className="absolute inset-0 bg-gradient-to-t from-[#051424] via-transparent to-[#051424]/50" />
        </div>
      ...
      <section id="services" className="py-[120px] bg-surface relative overflow-hidden">
        ...
        <div className="max-w-[1280px] mx-auto px-6 lg:px-12">
          <div className="flex items-center justify-center mb-6">
            <span className="label-caps text-secondary">What I Do</span>
          </div>
