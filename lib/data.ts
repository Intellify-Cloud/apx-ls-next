   ...
   scarf: {
    ...
    clients: {
      ...
      list: [
        ...
        { title: "DHS Attorneys Inc.", url: "#", logo: "/assets/clients/dhs-attorneys-logo.png" },
        { title: "Enviro Pro", url: "#", logo: "/assets/clients/enviropro-logo.png" },
        ...
        { title: "Miavana", url: "#", logo: "/assets/clients/miavana-logo.png" },
        ...
        { title: "Wilkinsons Insurance", url: "#", logo: "/assets/clients/wilkinsons-insurance-logo.png" },
        { title: "Yumbi", url: "#", logo: "/assets/clients/yumbi-logo.png" },
      ],
    },
...
subtitle: "Trusted by leaders across industries",
      people: [
        ...
        { name: "Gav Morris", company: "Wilkinsons Insurance", icon: "MessageSquare", testimony: "I have been working with Craigo for over 4 years now on general self-development, a more balanced life and in particular leadership in the workspace. As a young person starting out in the business world and navigating your late 20s at the same time, can be challenging, however, my regular sessions with Craigo have proven to be invaluable, as well as our once-off \"work team\" brainstorming session. Super grateful for the journey I have been able to share with Craigo, his professionalism, guidance and mentorship during all these years. Working with him as truly made me a better leader, person and have a more in depth understanding of myself which has subsequently positively overflowed into all aspects of work and personal life." },
        { name: "Anonymous", company: "Yumbi", icon: "MessageSquare", testimony: "Working with Craig Stuart came at a pivotal time in my career and life. I was transitioning into a senior leadership role, struggling with imposter syndrome and processing the loss of a loved one. Craig's coaching helped me build confidence, overcome self-doubt and navigate grief while continuing to perform professionally. What stood out most was his ability to challenge me in the right way. He encouraged me to lead with conviction and authenticity and one piece of advice that has stayed with me is: \"If your intentions are good, you may make people feel uncomfortable, but ensure that your intentions are good.\" That insight helped me become more comfortable making difficult leadership decisions while remaining true to my values. As a result of Craig's coaching, I successfully stepped into my senior leadership role, implemented initiatives that have positively impacted the business and most importantly, I now genuinely feel that I belong in leadership. Craig is authentic, thought-provoking and knows how to bring out the best in people. I would highly recommend him to emerging leaders and executives looking to grow their confidence, leadership capability and impact." },
        { name: "Brighton", company: "Yumbi", icon: "MessageSquare", testimony: "As a Tech Ops Manager, navigating fast-paced operational demands while effectively leading a technical team can be challenging. Working with Craig has been a game-changer. He helped me gain a profound understanding of myself, shedding light on both my key strengths and my leadership blind spots. Through our sessions, I've significantly improved my emotional intelligence, which has completely transformed how I handle high-pressure situations, communicate, and lead. Craig didn't just offer generic advice; he provided the practical tools I needed to transition from managing operations to empowering. I highly recommend Craig to any leader looking to drive genuine self-awareness and elevate their management skills." },
        { name: "Damian J", company: "Miavana", icon: "MessageSquare", testimony: "Over the course of his time working with me and the team, Craig has demonstrated an exceptional commitment to personal mastery and professional development. His approach goes beyond traditional training; he has a unique ability to help individuals recognize their strengths, unlock their potential, and fully utilize the tools already within their toolbox. Craig has guided team members on a journey of self-awareness, accountability, and growth, creating lasting improvements in both confidence and performance. His coaching style challenges people to think differently, take ownership, and strive for excellence, while remaining supportive and approachable throughout the process. The impact of his work has been evident across the team, with individuals becoming more empowered, capable, and effective in their roles. I would highly recommend Craig to any organization looking to develop high-performing teams, strong leaders, and a culture of continuous growth. His contribution has been fantastic, and the value he brings is significant and long-lasting." },
        { name: "STUART F.", company: "DHS Attorneys Inc.", icon: "MessageSquare", testimony: "Our leadership team's journey with Craig and Celia was truly transformative. The 5 Lens Enneagram opened our eyes to ourselves and each other, sparking a level of self-reflection we hadn't thought possible. Through powerful one-on-one coaching, engaging workshops, and strategic Directors' sessions, we discovered a shared language that ignited a new level of connection. We've not just improved our team dynamics; we've found a newfound sense of unity and clarity. We're deeply grateful for this experience." },
        { name: "Cliff", company: "One Mind Body Soul", icon: "MessageSquare", testimony: "Craig has played an integral role in my life for the past 2 years. I have appreciate his holistic approach to problems has changed my perspective on numerous occasions to see the opportunities that were right in front of me. Encouraging me to be bold in faith, when I've felt myself falter and always there to have compassion and understanding from a human perspective, often sharing some of his own life experiences to identify with the issues that I've had to face. I value Craig's input on most of my life and business decisions, he has not only been an invaluable life and leadership coach, but someone that I consider a close friend. Thank you Craig for your dependable support and guidance through these past couple of years." },
      ],
  },
