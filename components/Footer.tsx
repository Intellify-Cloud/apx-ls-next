    ...
    <footer className="bg-primary text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-400 text-sm">{footer.legal}</p>
          <nav aria-label="Legal links" className="flex gap-6 text-sm">
            <Link href="/privacy-statement" className="text-gray-400 hover:text-accent transition-colors">
              Privacy Statement
            </Link>
            <Link href="/data-sharing-agreement" className="text-gray-400 hover:text-accent transition-colors">
              Data Sharing
            </Link>
            <Link href="/legal" className="text-gray-400 hover:text-accent transition-colors">
              Legal
            </Link>
          </nav>
        </div>
