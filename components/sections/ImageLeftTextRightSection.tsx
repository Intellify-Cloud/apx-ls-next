...
interface ImageLeftTextRightSectionProps {
  title: string
  text: string
  image: string
  imageAlt: string
...
export default function ImageLeftTextRightSection({
  title,
  text,
  image,
  imageAlt,
  ctaText,
  ctaLink,
}: ImageLeftTextRightSectionProps) {
  return (
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            <span className="font-mono text-xs text-[#ed5c2c] tracking-widest uppercase mb-4 block">Our Process</span>
