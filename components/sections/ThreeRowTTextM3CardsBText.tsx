      ...
      <div className="max-w-[1000px] mx-auto px-6 py-20 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-14">
          {items.map((item, index) => (
            <div
              key={index}
              className="group flex flex-col items-center gap-4 p-8 rounded-2xl border border-outline-variant/10 shadow-sm transition-all duration-300 hover:border-secondary/20 hover:scale-[1.01] hover:shadow-glow-sm cursor-default bg-[#f1f5f9]"
            >
