  ...
  return (
    <section id="clients" className="py-20 bg-white relative overflow-hidden">
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
        ...
        <p className="font-normal text-[16px] leading-[26px] text-[rgba(12,26,55,0.7)] mb-14 max-w-[850px] mx-auto text-center">
          {clients.subtitle}
        </p>
        ...
        <div className="relative">
          ...
          <div className="flex animate-scroll gap-6 lg:gap-8 items-center">
            {duplicatedClients.map((client, index) => (
                <div
                  key={index}
                  className="group flex-shrink-0 -translate-y-1 bg-slate-50/80 rounded-lg border border-[rgba(12,26,55,0.12)] shadow-lg flex items-center justify-center w-[210px] md:w-[288px] aspect-[1.618/1] px-6 py-4 transition-colors duration-300 hover:border-secondary/35"
                >
                  {client.logo ? (
